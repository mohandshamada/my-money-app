          ...
          <div className="grid md:grid-cols-3 gap-4 mb-6">
            <div className="card p-4">
              ...
              <p className="text-2xl font-bold">
                ${(budgets || []).reduce((s, b) => s + (b.amount || 0), 0).toFixed(2)}
              </p>
            </div>
            <div className="card p-4">
              <p className="text-sm text-gray-600 dark:text-gray-400">Total Spent</p>
              <p className="text-2xl font-bold text-red-600">
                ${(budgets || []).reduce((s, b) => s + (b.spent || 0), 0).toFixed(2)}
              </p>
            </div>
            <div className="card p-4">
              ...
              <p className={`text-2xl font-bold ${
                ...
                ${(budgets || []).reduce((s, b) => s + (b.remaining || 0), 0).toFixed(2)}
              </p>
            </div>
          </div>
              ...
              <div key={budget.id} className="card hover:shadow-lg transition-shadow">
                <div className="flex items-start justify-between mb-3">
                  ...
                  <div className="flex gap-2">
                    <button
                      ...
                      className="p-2 hover:bg-gray-100 dark:hover:bg-gray-700 rounded focus:outline-none focus:ring-2 focus:ring-primary-500 transition-colors"
                    >
                    ...
                    <button
                      ...
                      className="p-2 hover:bg-red-50 dark:hover:bg-red-900/20 text-red-600 rounded focus:outline-none focus:ring-2 focus:ring-red-500 transition-colors"
                    >
                ...
                <div className="mb-3">
                  <div className="flex justify-between text-sm mb-1.5">
                    ...
                    <span className="font-medium">${Number(budget.amount || 0).toFixed(2)}</span>
                  </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className={`text-sm font-medium ${
                    ...
                    {budget.remaining >= 0 ? '' : '-'}${Math.abs(budget.remaining || 0).toFixed(2)} left
                  </span>
                </div>
              </div>
            ))}
