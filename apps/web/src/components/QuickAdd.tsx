    ...
    <div className="card">
      ...
      <div className="flex gap-2">
        ...
        <button
          ...
          className="px-4 py-3 bg-primary-600 text-white rounded-lg hover:bg-primary-700 disabled:opacity-50 focus:outline-none focus:ring-2 focus:ring-primary-500"
        >
      ...
      <div className="flex flex-wrap gap-2 mt-3">
        {examples.map((ex) => (
          <button
            ...
            className="text-xs px-2 py-2 bg-gray-100 hover:bg-gray-200 rounded-full text-gray-600 focus:outline-none focus:ring-2 focus:ring-gray-400"
          >
            {ex}
          </button>
        ))}
          ...
          {result.added ? (
            ...
            <div>
              ...
              <button
                ...
                className="mt-2 px-3 py-2 bg-primary-600 text-white text-sm rounded focus:outline-none focus:ring-2 focus:ring-primary-500"
              >
                Confirm
              </button>
            </div>
