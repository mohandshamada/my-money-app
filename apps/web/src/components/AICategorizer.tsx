    ...
    <div className="space-y-3">
      ...
      {!suggestion && (
        <button
          ...
          className="flex items-center gap-2 px-4 py-3 bg-gradient-to-r from-purple-500 to-indigo-600 text-white rounded-lg hover:from-purple-600 hover:to-indigo-700 disabled:opacity-50 transition-all focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 font-medium w-full sm:w-auto justify-center sm:justify-start"
        >
          {loading ? (
            <>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div className="flex items-center gap-3 min-w-0">
              ...
              <div className="min-w-0">
                ...
                <p className={`text-sm ${getConfidenceColor(suggestion.confidence)}`}>
                  Confidence: {getConfidenceLabel(suggestion.confidence)} ({((suggestion.confidence || 0) * 100).toFixed(0)}%)
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2 flex-shrink-0">
              <button
                ...
                className="flex items-center gap-1 px-3 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 text-sm focus:outline-none focus:ring-2 focus:ring-green-500 font-medium"
              >
              ...
              <button
                ...
                className="flex items-center gap-1 px-3 py-2 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300 text-sm focus:outline-none focus:ring-2 focus:ring-gray-400 dark:bg-gray-700 dark:text-gray-300 dark:hover:bg-gray-600 font-medium"
              >
