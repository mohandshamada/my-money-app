  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm overflow-hidden">
      ...
      >
        ...
        <button aria-label={expanded ? 'Collapse alerts' : 'Expand alerts'} className="p-2 text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 focus:outline-none focus:ring-2 focus:ring-primary-500 rounded-lg flex-shrink-0">
          {expanded ? '−' : '+'}
        </button>
      </div>
          ...
          {visibleAlerts.map((alert, i) => (
            ...
            >
              <button
                ...
                className="absolute top-2 right-2 p-2 hover:bg-black/5 dark:hover:bg-white/5 rounded focus:outline-none focus:ring-2 focus:ring-primary-500"
              >
                  ...
                  {alert.percentUsed && alert.budget && (
                    <div className="mt-2">
                      <div className="flex justify-between text-xs mb-1">
                        <span>${Number(alert.spent || 0).toFixed(0)} spent</span>
