...
import { LayoutDashboard, List, PiggyBank, TrendingUp, Settings, Wallet, Repeat } from 'lucide-react'
          ...
          {navItems.map((item) => (
            <li key={item.to}>
              <NavLink
                ...
                onClick={onClose}
                className={({ isActive }) =>
                  `flex items-center gap-3 px-4 py-3 rounded-lg transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-primary-500 ${
                    isActive
