  ...
  return (
    <div className="space-y-6">
      ...
      <button
        ...
        className="flex items-center gap-2 px-4 py-3 bg-primary-600 text-white rounded-lg hover:bg-primary-700 disabled:opacity-50 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 font-medium"
              ...
              <div className="flex flex-col sm:flex-row items-start justify-between gap-3 sm:gap-0">
                ...
                <div className="flex items-center gap-2 flex-shrink-0">
                  <button
                    ...
                    className="p-2.5 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-primary-500"
                  >
                  ...
                  <button
                    ...
                    className="p-2.5 hover:bg-red-50 text-red-600 rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-red-500"
                  >
